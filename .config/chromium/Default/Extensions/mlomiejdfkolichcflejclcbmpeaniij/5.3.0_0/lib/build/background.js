...
define("parseuri", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.parseUri;
    };
}(this)));
...
require([
	...
	'lib/utils',
	'tpl/click2play'
], function ($, _, parseUri, bugDb, c2pDb, compDb, tagDb, conf, dispatcher, foundBugs, ghostrank, i18n, matcher, surrogatedb, tabInfo, utils, c2p_tpl) {
